...
for sent,tar in zip(test,test_target):
    num_sents += 1
    num_words += len(sent)
...
print final_kendall
print "Total Kendall Tau sentences longer then 1:"
print kendall_without
print "Number of sentences longer then 1:"
print num_sents_without
final_kendall_without = kendall_without/num_sents_without
print "Kendall Tau longer then 1 average:"
